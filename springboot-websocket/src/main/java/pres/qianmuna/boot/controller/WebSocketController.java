...
import pres.qianmuna.boot.service.WebSocketService;
...
public class WebSocketController {
    ...
    public ResponseModel say(ResponseModel message) throws Exception {
        Thread.sleep(1000);
        return new ResponseModel("Welcome, " + message.getResponseMessage()+ "!");
    }
    ...
    public void handleChat(Principal principal, ResponseModel message) {
